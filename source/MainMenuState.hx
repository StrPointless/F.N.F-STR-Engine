...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			menuItem.frames = Paths.getSparrowAtlas('mainMenuAssets/menu_' + optionShit[i]);
		...
		add(versionShit);
		var versionShit2:FlxText = new FlxText(versionShit.x + 950, FlxG.height - 18, 0, "[ Friday Night Funkin' ] V. 0.2.7.1", 12);
